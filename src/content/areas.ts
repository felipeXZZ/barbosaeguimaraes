...
export const areas: Area[] = [
  {
    ...
    metaDescricao:
      "Atuação em Direito Bancário e Financeiro no centro de São Paulo: contratos, revisão de cláusulas, relação banco-cliente e conformidade regulatória. Escritório atuante desde 1982.",
    descricao: [
  ...
  },
  {
    ...
    metaDescricao:
      "Advocacia cível no centro de São Paulo: contratos, responsabilidade civil, direitos patrimoniais e disputas judiciais e extrajudiciais. Escritório atuante desde 1982.",
    descricao: [
