...
export const ANO_FUNDACAO = 1982;
...
export const site = {
  ...
  descricao:
    "Escritório de advocacia com sede no centro de São Paulo, atuando desde 1982 em dez áreas do direito, com atendimento em todo o território nacional.",
