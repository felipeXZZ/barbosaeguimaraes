...
export const metadata: Metadata = {
  ...
  description:
    "Escritório de advocacia no centro de São Paulo, atuante desde 1982 em dez áreas do direito, com atendimento em todo o território nacional. Fale com o escritório.",
